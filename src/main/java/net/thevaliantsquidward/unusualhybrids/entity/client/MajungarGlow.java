...
public class MajungarGlow extends GeoRenderLayer<MajungaraptorEntity> {
    ...
    public MajungarGlow(GeoRenderer<MajungaraptorEntity> entityRendererIn) {
        super(entityRendererIn);

    }

    public void render(PoseStack poseStack, MajungaraptorEntity entityLivingBaseIn, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
