...
public class OldMajungaraptorEntity extends EntityBaseDinosaurAnimal {
    private static final EntityDataAccessor<Boolean> PRESS = SynchedEntityData.defineId(OldMajungaraptorEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> SCALE = SynchedEntityData.defineId(OldMajungaraptorEntity.class, EntityDataSerializers.INT);
    ...
    public OldMajungaraptorEntity(EntityType<? extends EntityBaseDinosaurAnimal> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new OldMajungaraptorEntity.IMeleeAttackGoal());
                    ...
                    public boolean canUse() {
                        if (this.mob.isVehicle()) {
                            ...
                            if (!this.forceTrigger) {
                                ...
                                if (((OldMajungaraptorEntity) this.mob).isHungry()) {
    ...
    class IMeleeAttackGoal extends MeleeAttackGoal {
        public IMeleeAttackGoal() {
            super(OldMajungaraptorEntity.this, 1.6D, true);
        }
        ...
        protected void checkAndPerformAttack(LivingEntity enemy, double distToEnemySqr) {
            ...
            if (distToEnemySqr <= d0 && this.getTicksUntilNextAttack() <= 0) {
                ...
                ((OldMajungaraptorEntity) this.mob).setHungry(false);
                ((OldMajungaraptorEntity) this.mob).attack(enemy);
                ((OldMajungaraptorEntity) this.mob).setTimeTillHungry(mob.getRandom().nextInt(300) + 300);
            }
        }
    ...
    private static class PushButtonsGoal extends MoveToBlockGoal {
        private final OldMajungaraptorEntity raptor;

        private static final int WAIT_TICKS = 20;
        protected int ticksWaited;

        public PushButtonsGoal(OldMajungaraptorEntity pMob, double pSpeedModifier, int pSearchRange, int pVerticalSearchRange) {
        ...
        private void pushButton(BlockState blockstate) {
            // Your existing code
            ((OldMajungaraptorEntity) this.mob).pushingState = true;
    ...
    protected <E extends OldMajungaraptorEntity> PlayState Controller(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
        if (this.isFromBook()) {
    ...
    protected <E extends OldMajungaraptorEntity> PlayState attackController(final software.bernie.geckolib.core.animation.AnimationState<E> event) {
